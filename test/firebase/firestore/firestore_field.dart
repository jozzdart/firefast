  ...
  group('FirestoreField tests', () {
    ...
    group('Data types', () {
      test('handles various data types correctly', () async {
        ...
        final dateField = FireField<DateTime>(
          name: 'timestamp',
          toFire: () async => date,
          fromFire: (dynamic value) => value as DateTime,
        ).firestore(docPath);
    ...
    group('Edge cases', () {
      test('handles fields with special characters in name', () async {
        ...
        // Field with dots
        final dottedField = FireField<String>(
          name: 'field.with.dots',
          toFire: () async => 'dotted value',
          fromFire: (dynamic value) => value.toString(),
        ).firestore(docPath);
        ...
        final dottedResult = await dottedField.read();
        ...
        expect(dottedResult, 'dotted value');
